class Tabelas {
  ...
  criarPets() {
    const query =
      'CREATE TABLE IF NOT EXISTS Pets (id int NOT NULL AUTO_INCREMENT, nome varchar(11), imagem varchar(200), PRIMARY KEY (id))';
  ...
  criarServicos() {
    const sql = `CREATE TABLE IF NOT EXISTS Servicos (id int NOT NULL AUTO_INCREMENT, nome varchar(20) NOT NULL, preco int, PRIMARY KEY (id))`;
    this.conexao.query(sql, (erro) => {
      if (erro) {
        console.log(erro);
      } else {
